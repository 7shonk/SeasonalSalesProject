...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  loading.innerHTML = `
    <div style="display: flex; flex-direction: column; align-items: center; gap: 12px;">
      <i class="fa-solid fa-circle-notch fa-spin" style="font-size: 28px; color: #A50044;"></i>
  ...
  try {
    ...
    if (firstCardText) {
      ...
      firstCardText.innerHTML = `核心數據證實：前 10 大主力商品已強勢貢獻高達 <strong style="color: #A50044; font-size: 18px;">${topShareVal}%</strong> 的市場銷售總量，呈現極為顯著的 Pareto 長尾結構。`;
    }
    ...
    if (barCanvas) {
      ...
      gradientRed.addColorStop(0, "#A50044");
      gradientRed.addColorStop(1, "#6B002C");
    ...
    if (lineCanvas) {
      ...
      gradientBlue.addColorStop(0, "rgba(0, 77, 152, 0.25)");
