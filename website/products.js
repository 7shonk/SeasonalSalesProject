...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const renderChart = (labels, values, labelName) => {
    ...
    gradientGarnet.addColorStop(0, "rgba(165, 0, 68, 0.3)");
    gradientGarnet.addColorStop(1, "rgba(165, 0, 68, 0.0)");
    ...
    categoryChartInstance = new Chart(canvas, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: values,
          borderColor: "#A50044", // 巴薩紅
          borderWidth: 4,
          pointBackgroundColor: "#EDBB00", // 巴薩金
          pointBorderColor: "#A50044",
          pointRadius: 6,
          pointHoverRadius: 9,
          tension: 0.35,
          fill: true,
